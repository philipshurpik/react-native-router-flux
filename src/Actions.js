...
export const ActionMap = {
  ...
  removeFromStack: ActionConst.REMOVE_FROM_STACK,
  ...
  [ActionConst.REMOVE_FROM_STACK]: ActionConst.REMOVE_FROM_STACK,
};
...
class Actions {
  ...
  removeFromStack(props = {}) {
    return this.callback({ ...filterParam(props), type: ActionConst.REMOVE_FROM_STACK });
  }
